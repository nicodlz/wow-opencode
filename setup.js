...
try {
  ...
  console.log(`project  : ${cfg.defaultCwd}  (use Folders in game, or /oc cd)`);
...
Done. Next:
  ...
  3. Start OpenCode: opencode serve --hostname 127.0.0.1 --port 4096
  4. In another terminal, start the bridge: npm start
